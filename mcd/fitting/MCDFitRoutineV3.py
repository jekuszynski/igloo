...
if __name__ == '__main__':
    workingPath = 'C:/Users/roflc/Dropbox/Research/FSU/Strouse/Projects/Cd2SnO4/MCD/Raw/20221012'
    os.chdir(workingPath)

    material = 'Cd2SnO4-SnF2_Eg'
    dataYear = '2021'
    max_ev = 3.0
    min_ev = 2.7

    # MCD Paths
    signal_mcd = 'C:/Users/roflc/Dropbox/Research/FSU/Strouse/Projects/Cd2SnO4/MCD/Raw/20221012/SnF2 Sig/'
    blank_mcd = 'C:/Users/roflc/Dropbox/Research/FSU/Strouse/Projects/Cd2SnO4/MCD/Raw/20221012/SnF2 Blank/'
    ...
    # CFS7_NIR_mcd = '/mnt/c/Us`ers/roflc/Desktop/MCD DATA/7-1 CFS/NIR/MCD 04-02-21/'

    # # ABS Paths
    # CFS3_NIR_abs = "/mnt/c/Users/rcdoflc/Desktop/MCD DATA/3-1 CFS/NIR/ABS 04-08-21 NIR/"
    ...
    if dataYear == '2020':
        ...
        try:
            ...
            print("Missing columns. Did you select write file/folder paths?")
    ...
    zdf.to_csv(material + '_zeeman_data.csv', index=False)
    # plotABS(finalABSData, material, max_ev, min_ev) #used for 2020 data?
