...
if __name__ == '__main__':
    ...
    pars['cen2'].set(value=1.185973, vary=False, min=1, max=2.0)
    ...
    pars['ampB4'].set(value=0, vary=True)
    pars['cen4'].set(value=3.44, vary=False, min=2.5, max=4)
    ...
    pars['g4_amplitude'].set(value=.5, min=.2, vary=True)
    ...
    colors = ["#785EF0","#648FFF","#FE6100","#DC267F"]
    ...
    ax1.fill_between(x, list(mcd_comps.values())[1], color=colors[-2], lw=1.5, ls='--', label='IB-II', alpha=0.2)
    ax1.fill_between(x, list(mcd_comps.values())[2], color=colors[-3], lw=1.5, ls='--', label='CB', alpha=0.2)
    ax1.fill_between(x, list(mcd_comps.values())[3], color=colors[-4], lw=1.5, ls='--', label='UV Continumm', alpha=0.2)
    ax1.plot([1.127273,1.127273], [-3,3], color='gray', ls='-', lw=0.8)
    ax1.plot([1.185973,1.185973], [-3,3], color='gray', ls='-', lw=0.8)
    ax1.plot([1.771429,1.771429], [-3,3], color='gray', ls='-', lw=0.8)
    ax1.plot([3.441584,3.441584], [-3,3], color='gray', ls='-', lw=0.8)
    ...
    ax2.fill_between(abs_x, list(abs_comps.values())[1], color=colors[-2], lw=1.5, ls='--', label='IB-II', alpha=0.2)
    ax2.fill_between(abs_x, list(abs_comps.values())[2], color=colors[-3], lw=1.5, ls='--', label='CB', alpha=0.2)
    # ax2.fill_between(abs_x, list(abs_comps.values())[3], color=colors[-4], lw=1.5, ls='--', label='UV Continuum', alpha=0.2)
    ax2.fill_between(abs_x, list(abs_comps.values())[4], color=colors[-4], lw=1.5, ls='--', label='UV Continuum', alpha=0.2)
    # ax2.plot(abs_x, list(abs_comps.values())[4], color='purple', lw=1.5, ls='--', label='')
    ax2.plot([1.127273,1.127273], [-3,3], color='gray', ls='-', lw=0.8)
    ax2.plot([1.185973,1.185973], [-3,3], color='gray', ls='-', lw=0.8)
    ax2.plot([1.771429,1.771429], [-3,3], color='gray', ls='-', lw=0.8)
    ax2.plot([3.441584,3.441584], [-3,3], color='gray', ls='-', lw=0.8)

    ax2.legend(loc=0, prop={'size': 6})
    ax1.set_ylabel(r'MCD, $\Delta$A/A$_{\mathrm{max}}$ (x $10^{-3}$)',labelpad=6, size=9)
    ax2.set_ylabel(r'Absorbance, A (a.u.)',labelpad=13,size=9)

    ax1.set_xlim(2.5, 0.75)
